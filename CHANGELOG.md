...
- Added `scripts/validate-plugin-bundle.mjs` and wired it into `npm run check` plus GitHub Actions so plugin manifests, marketplace metadata, and the plugin README cannot drift silently
